...
## How SEOHead and Static Prerendering Work Together
...
<task type="auto">
  <name>Task 1: Create SEOHead component and fallback OG image</name>
  <files>src/components/SEOHead.jsx, public/images/og-default.svg</files>
  <action>
...
11. If no image provided, use "/images/og-default.svg" (NOTE: single shared filename with Plan 02)
...
**Fallback image:**
Create `public/images/og-default.svg` - a simple 1200x630 SVG with:
...
- Use `og-default.svg` (NOT `og-blog-default.svg`) - this filename is shared with Plan 02
  </action>
  <verify>
...
4. Fallback image exists: `ls public/images/og-default.svg`
5. Uses correct fallback filename: `grep "og-default.svg" src/components/SEOHead.jsx`
  </verify>
  <done>
SEOHead component exists with props for title, description, url, image, type, and article metadata. Fallback OG image exists at public/images/og-default.svg (shared filename with Plan 02).
  </done>
</task>
...
5. `og-default.svg` filename used (not `og-blog-default.svg`)
</verification>
...
- Fallback OG image is `og-default.svg` (shared with Plan 02)
</success_criteria>
